...
public interface ResourceUserMapper extends BaseMapper<ResourcesUser> {
     ...
     */
    List<Integer> queryResourcesIdListByUserIdAndPerm(@Param("userId") String userId,
                                                      @Param("perm") int perm);
     ...
     */
    int deleteResourceUser(@Param("userId") String userId,
     ...
     * @return delete result
     */
    int deleteResourceUserArray(@Param("userId") String userId,
