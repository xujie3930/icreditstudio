...
public class ProcessScheduleJob implements Job {
    ...
    public static void main(String[] args) {
        ...
        Map<String, String> value = (Map<String, String>) getValue(json, NEED_TRANSFER_COLUMNS);
        value.put("aaa", "bbb");
        Configuration configuration = setValue(json, NEED_TRANSFER_COLUMNS, value);
...
//            }
    ...
    public static Configuration setValue(String json, String path, Object newValue) {
        Configuration from = Configuration.from(json);
        Object js = from.get(TASK_PARAM_JSON);
        Configuration content = Configuration.from(JSONUtil.toJsonStr(js));
        content.set(path, newValue);
