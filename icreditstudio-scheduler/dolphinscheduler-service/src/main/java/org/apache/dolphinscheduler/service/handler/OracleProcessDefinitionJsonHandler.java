...
@Slf4j
@Component
public class OracleProcessDefinitionJsonHandler extends AbstractProcessDefinitionJsonHandler {
    ...
    public String handler(PlatformPartitionParam partitionParam, String processDefinitionJson) {
        ...
        if (Objects.nonNull(value)) {
            ...
            String mysql = IncrementUtil.getTimeIncQueryStatement(value.toString(), "oracle", partitionParam.getIncrementalField(), startTime, endTime);
            //替换查询语句
