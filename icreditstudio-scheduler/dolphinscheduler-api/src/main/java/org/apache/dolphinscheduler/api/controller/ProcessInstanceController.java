...
//     * @param stateType           state paramType
//     * @param host                host
...
//            @ApiImplicitParam(name = "executorName", value = "EXECUTOR_NAME", paramType = "String"),
//            @ApiImplicitParam(name = "stateType", value = "EXECUTION_STATUS", paramType = "ExecutionStatus"),
//            @ApiImplicitParam(name = "host", value = "HOST", paramType = "String"),
//            @ApiImplicitParam(name = "startDate", value = "START_DATE", paramType = "String"),
//            @ApiImplicitParam(name = "endDate", value = "END_DATE", paramType = "String"),
...
//    @ApiImplicitParams({
//            @ApiImplicitParam(name = "processInstanceJson", value = "PROCESS_INSTANCE_JSON", paramType = "String"),
//            @ApiImplicitParam(name = "processInstanceId", value = "PROCESS_INSTANCE_ID", required = true, dataType = "Int", example = "100"),
//            @ApiImplicitParam(name = "scheduleTime", value = "SCHEDULE_TIME", paramType = "String"),
//            @ApiImplicitParam(name = "syncDefine", value = "SYNC_DEFINE", required = true, paramType = "Boolean"),
//            @ApiImplicitParam(name = "locations", value = "PROCESS_INSTANCE_LOCATIONS", paramType = "String"),
//            @ApiImplicitParam(name = "connects", value = "PROCESS_INSTANCE_CONNECTS", paramType = "String"),
//            @ApiImplicitParam(name = "flag", value = "RECOVERY_PROCESS_INSTANCE_FLAG", paramType = "Flag"),
//    })
...
//                try {
//                    Map<String, Object> deleteResult = processInstanceService.deleteProcessInstanceById(loginUser, projectName, strProcessInstanceId);
