...
import prg.apache.dolphinscheduler.server.master.runner.MasterExecThread;
...
public class MasterExecThreadTest {
    ...
    public void testParallelWithOutSchedule() throws ParseException {
        try {
            ...
            Mockito.verify(processService, Mockito.times(20)).saveProcessInstance(processInstance);
        } catch (Exception e) {
            e.printStackTrace();
            Assert.fail();
        }
