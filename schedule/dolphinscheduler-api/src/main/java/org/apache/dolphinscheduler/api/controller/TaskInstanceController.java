...
public class TaskInstanceController extends BaseController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "processInstanceName", value = "PROCESS_INSTANCE_NAME", required = false, paramType = "String"),
            @ApiImplicitParam(name = "searchVal", value = "SEARCH_VAL", paramType = "String"),
            @ApiImplicitParam(name = "taskName", value = "TASK_NAME", paramType = "String"),
