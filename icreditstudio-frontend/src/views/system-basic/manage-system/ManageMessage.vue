...
import tableConfiguration from '@/views/system-basic/configuration/table/manage/manage-message'
import formOption from '@/views/system-basic/configuration/form/manage/manage-message'
