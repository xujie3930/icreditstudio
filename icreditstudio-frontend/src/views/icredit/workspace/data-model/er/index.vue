...
-->
<template>
  <div class="er-page" ref="container" id="container"></div>
</template>
...
export default {
  ...
  methods: {
    renderChart() {
      ...
      const rawData = [
        {
          ...
          label: 'Employee',
          attrs: [
            { key: 'id', type: 'number(6)' },
            { key: 'key', type: 'varchar(255)' },
            { key: 'gender', type: 'enum(M, F)' },
            { key: 'birthday', type: 'date' },
            { key: 'hometown', type: 'varchar(255)' },
            { key: 'country', type: 'varchar(255)' },
            { key: 'nation', type: 'varchar(255)' },
            {
              key: 'jobId',
              type: 'number(3)',
              relation: [
      ...
      this.$nextTick(() => {
        const { offsetWidth, clientHeight } = this.$refs.container
        console.log('sxcfv', this.$refs, offsetWidth, clientHeight)
        const width = offsetWidth || 1200
        const height = clientHeight || 700
