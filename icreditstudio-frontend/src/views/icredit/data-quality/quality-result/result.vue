...
import formOption from '@/views/icredit/configuration/form/govern-quality-result'
import tableConfiguration from '@/views/icredit/configuration/table/govern-quality-result'
