...
import formOption from '@/views/icredit/configuration/form/govern-quality-rules'
import tableConfiguration from '@/views/icredit/configuration/table/govern-quality-rules'
