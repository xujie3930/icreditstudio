...
import result from '../module/workbench/script/result.vue';
import log from '../module/workbench/script/log.vue';
import weProgress from '../module/workbench/script/progress.vue';
import Execute from '../module/workbench/script/execute';
export default {
  components: {
    result,
    log,
