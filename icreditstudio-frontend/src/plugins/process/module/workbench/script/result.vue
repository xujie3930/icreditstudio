...
// import Table from '../../component/table'; lizheng
import WeWaterMask from '../../../component/watermark';
import WeToolbar from './toolbar.vue';
import elementResizeEvent from '../../../helper/elementResizeEvent';
import resultSetList from './resultSetList.vue';
import pinyin from 'pinyin';
export default {
  components: {
    // WeTable: Table.WeTable, lizheng
    WeToolbar,
    WeWaterMask,
    resultSetList,
  },
