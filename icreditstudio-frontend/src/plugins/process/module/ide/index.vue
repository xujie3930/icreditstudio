...
import workSidebarModule from '../workSidebar';
import fnSidebarModule from '../fnSidebar';
import hiveSidebarModule from '../hiveSidebar';
import hdfsSidebarModule from '../hdfsSidebar';
