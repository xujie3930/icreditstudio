...
object SysConstants {
  ...
  private[engine] val SYS_SPARK_CONFIG = scala.collection.mutable.Map.empty[String, String]
  private[engine] val SYS_DEFINED_TABLES = scala.collection.mutable.Set.empty[String]
