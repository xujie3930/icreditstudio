...
import com.micro.cloud.config.swagger.SwaggerProperties;
...
@ConditionalOnProperty(prefix = "micro.swagger", value = "enable", matchIfMissing = true)
// 允许使用 swagger.enable=false 禁用 Swagger
@EnableConfigurationProperties(SwaggerProperties.class)
public class MicroSwaggerAutoConfiguration {
