package com.micro.cloud.sms.core.client.impl.aliyun;
...
import com.micro.cloud.sms.core.client.impl.AbstractSmsClient;
import com.micro.cloud.sms.core.enums.SmsTemplateAuditStatusEnum;
import com.micro.cloud.sms.core.property.SmsChannelProperties;
import com.micro.cloud.util.collection.MapUtils;
...
public class AliyunSmsClient extends AbstractSmsClient {
  ...
  protected void doInit() {
    IClientProfile profile =
        DefaultProfile.getProfile(ENDPOINT, properties.getApiKey(), properties.getApiSecret());
    client = new DefaultAcsClient(profile);
  }

  @Override
  protected SmsCommonResult<SmsSendRespDTO> doSendSms(
      Long sendLogId,
      String mobile,
    ...
    return statuses.stream()
        .map(
            status -> {
              ...
              resp.setLogId(Long.valueOf(status.getOutId()));
              return resp;
            })
  ...
  protected SmsCommonResult<SmsTemplateRespDTO> doGetSmsTemplate(String apiTemplateId) {
    ...
    return invoke(
        ...
        response -> {
          ...
          data.setId(response.getTemplateCode());
  ...
  @VisibleForTesting
  <T extends AcsResponse, R> SmsCommonResult<R> invoke(
      AcsRequest<T> request, Function<T, R> responseConsumer) {
    try {
      ...
      return SmsCommonResult.build(
          ex.getErrCode(), formatResultMsg(ex), ex.getRequestId(), null, codeMapping);
    }
  }
   ...
   * 短信接收状态
   *
   * <p>参见 https://help.aliyun.com/document_detail/101867.html 文档
   *
   * @author 芋道源码
   */
  public static class SmsReceiveStatus {
     ...
     * 短信长度，例如说 1、2、3
     *
     * <p>140 字节算一条短信，短信长度超过 140 字节时会拆分成多条短信发送
     */
