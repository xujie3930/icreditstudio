package com.micro.cloud.mybatis.core.query;
...
public class QueryWrapperX<T> extends QueryWrapper<T> {
  ...
  public QueryWrapperX<T> like(boolean condition, String column, String val) {
    if (condition) {
      return (QueryWrapperX<T>) super.like(column, Util.escapeStr(val));
    }
    return this;
  }
